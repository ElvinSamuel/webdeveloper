  ...
  $.fn.slabText = function(options) {
    ...
    return this.each(function() {
      ...
      var $this = $(this),
        ...
        words = keepSpans
          ? []
          : String($.trim($this.text())).replace(/\s{2,}/g, " ").split(" "),
        origFontSize = null,
      ...
      if (
        !keepSpans &&
        minCharsPerLine &&
        words.join(" ").length < minCharsPerLine
      ) {
        return;
      }
      ...
      var resizeSlabs = function resizeSlabs() {
        ...
        if (
          (viewportBreakpoint && viewportBreakpoint > viewportWidth) ||
        ...
        if (!keepSpans && (forceNewCharCount || fs != origFontSize)) {
          ...
          var newCharPerLine = Math.min(
            60,
            Math.floor(parentWidth / (origFontSize * fontRatio))
          ),
            wordIndex = 0,
            lineText = [],
            counter = 0,
          ...
          if (newCharPerLine != 0 && newCharPerLine != idealCharPerLine) {
            ...
            while (wordIndex < words.length) {
              ...
              if (
                preDiff < postDiff &&
                preText.length >= (minCharsPerLine || 2)
              ) {
                finalText = preText;
                wordIndex--;
              } else {
        ...
        $("span.slabtext", $this).each(function() {
          ...
          $span.css(
            "font-size",
            Math.min(
              (fontSize * ratio).toFixed(precision),
            ...
            $span.css(
              ...
              (diff /
                (wordSpacing
                  ...
                  : innerText.length)).toFixed(precision) + "px"
            );
          }
        });
